...
export function load() {
  return {
    ...
    promise: (client) => client.get('/serviceapi/widget/load/param1/param2') // params not used, just shown as demonstration
  };
}
...
export function save(widget) {
  return {
    ...
    id: widget.id,
    promise: (client) => client.post('/serviceapi/widget/update', {
      data: widget
    })
  };
}
